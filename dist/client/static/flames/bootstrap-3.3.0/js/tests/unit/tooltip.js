...
$(function () {
  ...
  test('should show tooltips with different delegate selectors on the same node on click', function () {
    var tooltipHTML = '<div>' + '<a href="#" class="first" rel="tooltip" title="First delegated tooltip"/>' + '<a href="#" class="second" rel="tooltip" title="Second delegated tooltip"/>' + '</div>';

    var $div = $(tooltipHTML).append().appendTo('#qunit-fixture').bootstrapTooltip({
  ...
  test('should be placed dynamically with the dynamic placement option', function () {
    ...
    var $topTooltip = $('<div style="left: 0; top: 0;" rel="tooltip" title="Top tooltip">Top Dynamic Tooltip</div>').appendTo($container).bootstrapTooltip({ placement: 'auto' });
    ...
    var $rightTooltip = $('<div style="right: 0;" rel="tooltip" title="Right tooltip">Right Dynamic Tooltip</div>').appendTo($container).bootstrapTooltip({ placement: 'right auto' });
    ...
    var $leftTooltip = $('<div style="left: 0;" rel="tooltip" title="Left tooltip">Left Dynamic Tooltip</div>').appendTo($container).bootstrapTooltip({ placement: 'auto left' });
